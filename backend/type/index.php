        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <span class="m-0"> <i class="nav-icon far fa-object-group"></i> ประเภทสินค้า (Type)</span>
                        </div>
                        <div class="col-sm-6">
                        </div>
                    </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <table name="tableType" id="tableType"
                                ...
                                <thead class="sticky-top table-defalut bg-dark">
                                    <tr>
                                        <th width="70%">ชื่อประเภทสินค้า</th>
                                        <th width="30%">สถานะการใช้งาน</th>
                                    </tr>
                                </thead>
