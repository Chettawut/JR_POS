<?php
    ...
    $StrSQL = "INSERT INTO customer (`cuscode`, `prename`, `cusname`, `idno`, `road`, `subdistrict`, `district` ";
    $StrSQL .= ",`province`, `zipcode`, `tel`, `fax`, `taxnumber`, `email`, `status`,`s_date`,`s_time`, s_user) ";
    $StrSQL .= "VALUES (";
    $StrSQL .= "'".$_POST["add_cuscode"]."','".$_POST["add_prename"]."','".$_POST["add_cusname"]."','".$_POST["add_idno"]."','".$_POST["add_road"]."' ";
